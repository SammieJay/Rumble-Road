...
ParticleSystem::ParticleSystem(const glm::vec3 &position, Geometry *geom, Shader *shader, TextureHandler* tex, GameObject *parent)
	: GameObject(position, geom, shader, ParticleSys){
...
void ParticleSystem::Render(glm::mat4 view_matrix, double current_time){
    ...
    glm::mat4 parent_rotation_matrix = glm::rotate(glm::mat4(1.0f), parent->GetRotation(), glm::vec3(0.0, 0.0, 1.0));
    glm::mat4 parent_translation_matrix = glm::translate(glm::mat4(1.0f), parent->GetPosition());
