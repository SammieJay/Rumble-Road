...
void main()
{
    ...
    float gravity = 0.5; // Gravity in this world
    ...
    pos = vec4(vertex.x + acttime*speed*dir.x , vertex.y + acttime*speed*dir.y , 0, 1.0);
    ...
    color_interp = vec4(t, 0.0, 0.0, 1)/(acttime*4);//fade over time
